...
const Speaking: React.FC = () => {
  ...
  const speakingExercises = [
    ...
    { id: 6, phrase: 'data mining', tip: '注意 "mining" 的发音，重音在第一个音节' },
    { id: 7, phrase: 'data preprocessing', tip: '注意短语间的连读' },
    { id: 8, phrase: 'data quality', tip: '注意 "quality" 的发音' },
    
    // Python相关术语
    { id: 9, phrase: 'Python programming', tip: '"Python" 的发音重音在第一个音节' },
    { id: 10, phrase: 'NumPy array', tip: '"NumPy" 发音为 /ˈnʌmpaɪ/' },
    { id: 11, phrase: 'Pandas DataFrame', tip: '"Pandas" 发音为 /ˈpændəs/' },
    { id: 12, phrase: 'Matplotlib plot', tip: '"Matplotlib" 发音为 /mætˈplɒtlib/' },
    { id: 13, phrase: 'Seaborn visualization', tip: '"Seaborn" 发音为 /ˈsiːbɔːrn/' },
    { id: 14, phrase: 'Scikit-learn', tip: '"Scikit-learn" 发音为 /ˈsaɪkɪt lɜːrn/' },
    { id: 15, phrase: 'data cleaning', tip: '注意 "cleaning" 的发音' },
    { id: 16, phrase: 'data transformation', tip: '注意 "transformation" 的重音位置' },
    { id: 17, phrase: 'data aggregation', tip: '注意 "aggregation" 的发音' },
    { id: 18, phrase: 'time series analysis', tip: '注意短语间的连读' },
    { id: 19, phrase: 'machine learning model', tip: '注意 "learning" 和 "model" 之间的连读' },
    { id: 20, phrase: 'feature engineering', tip: '注意 "engineering" 的发音' },
    { id: 21, phrase: 'model training', tip: '注意短语间的连读' },
    { id: 22, phrase: 'model evaluation', tip: '注意 "evaluation" 的发音' },
    
    // 商务数据分析术语
    { id: 23, phrase: 'business analytics', tip: '注意 "analytics" 的发音' },
    { id: 24, phrase: 'key performance indicator', tip: '注意短语间的停顿和重音' },
    { id: 25, phrase: 'dashboard', tip: '注意 "dashboard" 的发音' },
    { id: 26, phrase: 'market analysis', tip: '注意短语间的连读' },
    { id: 27, phrase: 'customer analytics', tip: '注意短语间的连读' },
    { id: 28, phrase: 'sales analysis', tip: '注意短语间的连读' },
    { id: 29, phrase: 'financial analysis', tip: '注意短语间的连读' },
    { id: 30, phrase: 'risk analysis', tip: '注意短语间的连读' },
  ];
